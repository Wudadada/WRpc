#ifndef __WQD_HTTP_SERVLET_H__
#define __WQD_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(wqd::http::HttpRequest::ptr request
                   ...
                   , wqd::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (wqd::http::HttpRequest::ptr request
                   , wqd::http::HttpResponse::ptr response
                   , wqd::http::HttpSession::ptr session)> callback;
