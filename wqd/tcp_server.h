#ifndef __WQD_TCP_SERVER_H__
#define __WQD_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(wqd::IOManager* worker = wqd::IOManager::GetThis()
              ,wqd::IOManager* io_woker = wqd::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(wqd::Address::ptr addr, bool ssl = false);
