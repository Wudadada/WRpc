#ifndef __WQD_CONFIG_H__
#define __WQD_CONFIG_H__
...
public:
    ...
    std::string toString() override {
        try {
            ...
            WQD_LOG_ERROR(WQD_LOG_ROOT()) << "ConfigVar::toString exception "
    ...
    bool fromString(const std::string& val) override {
        try {
            ...
            WQD_LOG_ERROR(WQD_LOG_ROOT()) << "ConfigVar::fromString exception "
...
public:
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string& name,
        ...
        if(it != GetDatas().end()) {
            ...
            if(tmp) {
                WQD_LOG_INFO(WQD_LOG_ROOT()) << "Lookup name=" << name << " exists";
                return tmp;
            } else {
                WQD_LOG_ERROR(WQD_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
        ...
        if(name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678")
                != std::string::npos) {
            WQD_LOG_ERROR(WQD_LOG_ROOT()) << "Lookup name invalid " << name;
