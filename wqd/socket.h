#ifndef __WQD_SOCKET_H__
#define __WQD_SOCKET_H__
...
public:
     ...
     * @param[in] address 地址
     */
    static Socket::ptr CreateTCP(wqd::Address::ptr address);

    /**
     * @brief 创建UDP Socket(满足地址类型)
     * @param[in] address 地址
     */
    static Socket::ptr CreateUDP(wqd::Address::ptr address);
...
public:
    ...
    static SSLSocket::ptr CreateTCP(wqd::Address::ptr address);
